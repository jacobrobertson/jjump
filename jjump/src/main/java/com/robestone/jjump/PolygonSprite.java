...
public class PolygonSprite extends SimpleSprite implements PolygonPaintable {
	...
	public PolygonSprite(String name, int borderThickness,
	...
	public PolygonSprite(String name) {
		super(name, name);
	}
